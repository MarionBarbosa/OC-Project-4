  ...
  var defaults = {
    ...
    builtInValidators: {
      ...
      validemail: {
        ...
        message:
          "Adresse email incorrecte<!-- data-validator-validemail-message to override -->",
      },
      passwordagain: {
        name: "Passwordagain",
        type: "match",
        match: "password",
        message:
          "Le mot de passe ne correspond pas<!-- data-validator-paswordagain-message to override -->",
      },
      positive: {
        name: "Positive",
        type: "shortcut",
      ...
      number: {
        ...
        regex: "([+-]?\\d+(\\.\\d*)?([eE][+-]?[0-9]+)?)?",
        message:
          "Doit être au format numérique<!-- data-validator-number-message to override -->",
      },
      integer: {
        name: "Integer",
        type: "regex",
        regex: "[+-]?\\d+",
        message:
          "Pas de virgule autorisée<!-- data-validator-integer-message to override -->",
      },
      positivenumber: {
        name: "Positivenumber",
        type: "min",
        min: 0,
        message:
          "Doit être un nombre positif<!-- data-validator-positivenumber-message to override -->",
      },
      negativenumber: {
        name: "Negativenumber",
        type: "max",
      ...
      required: {
        ...
        type: "required",
        message:
          "Champ obligatoire<!-- data-validator-required-message to override -->",
      },
      checkone: {
        name: "Checkone",
        type: "minchecked",
